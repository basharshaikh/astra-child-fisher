...
$conyuge     = get_field('conyuge');
$dependientes = get_field('dependiente');
$note_personal_info = get_field('note-personal-info');
...
|---------------------------------------------------------------------
*/ 
$residencia      = get_field('residencia');
...
$otros_inmuebles = get_field('otros_inmuebles');
$otros_inmuebles = $otros_inmuebles['inmuebles'];

$vehiculos       = get_field('vehiculos_info_fina');
$vehiculos       = $vehiculos['vehiculoss'];


$otros_pos_var   = get_field('otros_posesiones_varias');
$cuentas_banca_efect  = get_field('cuentas_bancarias_y_efectivo');


$deposit_inve  = get_field('depositos_e_inversiones');
$saldo_de_afp  = get_field('saldo_de_afp');

$note_financial_info = get_field('note-financial-info');
...
|---------------------------------------------------------------------
*/ 
$posesiones__sala = get_field('posesiones__sala');
...
|---------------------------------------------------------------------
*/ 
$gastos_medicos = get_field('gastos_medicos');
...
$plan_de_retiro = get_field('plan_de_retiro');
$vida_prot_ingr = get_field('vida_-_proteccion_de_ingresos');
$vida_deuda = get_field('vida_-_deuda');
$danos_residenciales = get_field('danos_residenciales');
$seg_vehiculos = get_field('vehiculos');

$seg_legal = get_field('legal');

$note_seguros = get_field('note-seguros');
...
|---------------------------------------------------------------------
*/ 
$prestamos_hipotecarios = get_field('prestamos_-_hipotecarios');
$prestamos_personales   = get_field('prestamos_-_personales');
$tarjeta_credito   = get_field('tarjetastarjetas_de_credito');
$extrafinanciamientos   = get_field('extrafinanciamientos_compras_a_plazos');
$vehiculoss   = get_field('vehiculo');
$otrosss   = get_field('otros');

$note_deudas_info = get_field('note-deudas-detail');
$group_deudas_strategy = get_field('estrategia_de_deudas');
...
|---------------------------------------------------------------------
*/ 
$bl_cuentas_banca_efect  = get_field('cuentas_bancarias_y_efectivo');
...
$bl_deop_inves  = get_field('depositos_e_inversiones');


$group_balance_genral = get_field('balance_personal');
...
|-----------------------------------------------------------------
*/
$salarios = get_field('salarios');
$servi_profes = get_field('servicios_profesionales');
$empresa = get_field('empresa');
$ingresos_otros = get_field('ingresos_-_otros_');
$calc_de_prestac = get_field('calculo_de_prestaciones');
$calc_de_prestac_adi = get_field('calculo_de_prestaciones_adi');
...
|-----------------------------------------------------------------
*/
$provisiones__mantenim_repara = get_field('casa_provisiones');
...
//------// GASTOS MENSUALES
$gastos_mensuales_grp = get_field('gastos_mensuales');
...
|-----------------------------------------------------------------
*/
$guia_ingreso_soltero = get_field('guia_ingreso_soltero');
...
|-----------------------------------------------------------------
*/
$guia_ingreso_familiar = get_field('guia_ingreso_familiar');
